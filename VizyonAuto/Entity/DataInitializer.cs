        ...
        protected override void Seed(DataContext context)
        {
            ...
            var urunler = new List<Product>()
            {
                ...
                new Product(){
                    ...
                    Description = "Quattro Design Audi A6 Sedan, kavisli arka kenara sahip kısa bagaj bölmesi kapağının ortaya çıkardığı dinamik stiliyle öne çıkar. Audi A6 Sedan'ın cömertçe tasarlanmış iç mekanı çok sayıda konfor ve rahatlık özelliği, bireysel olarak ayarlanabilen bir kullanım konsepti ve düşük bir gürültü seviyesi sunar. Ön kısım, yeni bir yapıya sahip Audi Singleframe ve selenit gümüş dekoratif unsurlara sahip yan hava girişleri ile öne çıkıyor.",
                    Price = 5723019,
                    Stock = 19,
                    IsApproved = true,
                    CategoryId = 1,
                ...
                new Product(){
                    ...
                    Description = "Audi A7 Sportback, metalik Suzuka grisi Audi S Line Quattro kişiselleştirilmiş gövde rengi ile öne çıkar. Audi A7 Sportback, sportifliği ve zarafeti bir araya getiriyor. Bu özelliği klasik quattro mimarisi ile etkileyici bir şekilde vurgulanıyor. Audi A7 Sportback, hem iş hem de eğlence için dinamik çok yönlü bir araçtır. Zarif coupé tasarımı, yeni bir yapıya sahip Audi Singleframe gibi yeni sportif vurgularla öne çıkar.",
                    Price = 4256420,
                    Stock = 11,
                    IsApproved = true,
                    CategoryId = 1,
                ...
                new Product(){
                    ...
                    Description = "Audi A8 L, Önde, arkada ve kapı kollarında bulunan parlak krom, zarif vurgular ekler ve aracın gövde rengine özel bir kontrast sağlar. Metalik Firmament mavi renkli yeni Audi A8 L, daha fazla baş ve bacak mesafesinin yanı sıra, son derece ferah bir ortama sahiptir. Daha uzun aks mesafesi ve daha geniş kapılarla benzerlerinden üstün bir tasarım.",
                    Price = 6421760,
                    Stock = 7,
                    IsApproved = true,
                    CategoryId = 1,
                ...
                new Product(){
                    ...
                    Description = "Audi Q7, S-Line Quattro dört tekerlekten çekiş, sportif kullanımıyla öne çıkar. Audi drive select dinamik yol tutuş sistemi ile aracın yüksekliğini düzenleyen isteğe bağlı spor süspansiyon da dahil olmak üzere aracın özelliklerini aktif olarak etkileyebilirsiniz. Audi Q7'de isteğe bağlı yalpalama stabilizasyonu yan savrulmayı azaltır ve opsiyonel tüm tekerlerden yönlendirme, daha kolay ve daha sportif yol tutuşu sağlar.",
                    Price = 7052204,
                    Stock = 14,
                    IsApproved = true,
                    CategoryId = 1,
                ...
                new Product(){
                    ...
                    Description = "Audi Q8, Quattro S-Line, arkadan tahrikli ve her bir tekerlek için hassas bir şekilde ölçülü. Kendinden kilitlenen merkez diferansiyeline sahip quattro sürekli dört tekerlekten çekiş, tahrik gücünü ön ve arka akslar arasında 40:60 oranında dağıtarak olağanüstü çekiş ve yön dengesi sağlar. Güçlü konturlar, atletik bir tavan kemeri ve sürekli dört tekerlekten çekişin gücü; yüksek kaliteyi ve özel dinamikleri birleştirir. Audi Q8, standart olarak MMI dokunmatik tepkili MMI navigasyon plus ile donatılmıştır. Audi Q8'in radyatör ızgarası, öne monte edilmiş spoyler ve geniş hava girişleri ile birleşerek kendine güvenen görünümünü vurgular.",
                    Price = 8112500,
                    Stock = 8,
                    IsApproved = true,
                    CategoryId = 1,
